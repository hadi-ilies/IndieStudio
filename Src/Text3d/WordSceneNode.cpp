 ...
 */
WordSceneNode::WordSceneNode(Window &_window, std::string _str, const SColor &color,
                             IrrFontBuffer &irrFontBuffer) : window(_window), str(std::move(_str)),
                                                             charSize(irrFontBuffer.getCharSize()) {
...
WordSceneNode::addTranslation(const core::vector3df &destPos, const u32 &timestamp) {
